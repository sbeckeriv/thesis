...
ActiveRecord::Schema.define(:version => 20110130031044) do
  ...
  add_index "classifications", ["entry_id"], :name => "index_classifications_on_entry_id"
  ...
  add_index "stream", ["entry_id"], :name => "index_stream_on_entry_id"
  add_index "stream", ["user_id"], :name => "index_stream_on_user_id"
